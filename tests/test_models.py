...
class TestDatabaseSchema:
    ...
    def test_users_table_exists(self):
        ...
        assert (
            "json" in str(master_profile_col["type"]).lower()
    ...
    def test_applications_table_exists(self):
        ...
        inspector = inspect(engine)
        assert (
            "applications" in inspector.get_table_names()
        ...
        assert (
            "users" in fk_tables and "jobs" in fk_tables
    ...
    def test_prep_guides_table_exists(self):
        ...
        inspector = inspect(engine)
        assert (
            "prep_guides" in inspector.get_table_names()
        ), "prep_guides table does not exist"
    ...
    def test_weekly_reports_table_exists(self):
        ...
        inspector = inspect(engine)
        assert (
            "weekly_reports" in inspector.get_table_names()
        ), "weekly_reports table does not exist"
